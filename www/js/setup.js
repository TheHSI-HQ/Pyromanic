(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document
      .getElementById("show-button-repeat")
      .addEventListener("mousedown", () => {
        document.getElementById("show-button-repeat").querySelector("img").src =
          "res/img/icon-eye_on.img";
        document.getElementById("pyro-password-repeat").type = "text";
      });
    document
      .getElementById("show-button-repeat")
      .addEventListener("mouseup", () => {
        document.getElementById("show-button-repeat").querySelector("img").src =
          "res/img/icon-eye_off.img";
        document.getElementById("pyro-password-repeat").type = "password";
      });
    ...
    document.getElementById("submit").addEventListener("click", (e) => {
      ...
      let password_confirm = document.getElementById("pyro-password-repeat");
      if (username.value == "") {
        username.focus();
        return;
      }
      ...
      if (password_confirm.value != password.value) {
        document.getElementById("pyro-info").innerHTML =
      ...
      form.action = "<<base>>/setup" + location.search;
      form.method = "POST";
    ...
    document
      .getElementById("pyro-password-repeat")
      .addEventListener("keypress", (e) => {
        if (e.key.toLowerCase() == "enter") {
          let username = document.getElementById("pyro-username");
          let password = document.getElementById("pyro-password");
